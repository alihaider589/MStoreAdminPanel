      ...
      <Content>
        <List>
          ...
          <ListItem itemHeader first>
            ...
            <Text style={{fontSize:20,fontWeight:'bold'}}>Sales Rating (4.5)</Text>
...
<ListItem itemHeader first>
  ...
  <Text style={{fontSize:20,fontWeight:'bold'}}>Sales Rating (4)</Text>
...
<ListItem itemHeader first>
  ...
  <Text style={{fontSize:20,fontWeight:'bold'}}>Sales Rating (3.5)</Text>
...
<ListItem itemHeader first>
  ...
  <Text style={{fontSize:20,fontWeight:'bold'}}>Sales Rating (3)</Text>
